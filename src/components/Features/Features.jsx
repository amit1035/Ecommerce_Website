      ...
      <div className="container mx-auto flex flex-wrap justify-around">
        <div className="w-full md:w-1/3 mb-6 p-4">
          <div className="flex flex-col items-center">
            <img src="https://sc0.blr1.cdn.digitaloceanspaces.com/article/107164-cbtamlwear-1543830910.jpg" alt="Affordable Prices" className="w-full h-full object-cover rounded-lg" />
